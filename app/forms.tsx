...
export function LeadForm({ fields, submitLabel, successTitle, successText, locale = "zh" }: { fields: readonly Field[]; submitLabel?: string; successTitle?: string; successText?: string; locale?: "zh" | "de" | "en" }) {
  ...
  return <>
    <form className="lead-form" onSubmit={submit}>
      ...
      <label className="consent"><input type="checkbox" required /> <span>{copy.consentBefore}<a href={locale === "zh" ? "/privacy" : `/${locale}/privacy`} target="_blank">{copy.privacy}</a>{copy.consentAfter}</span></label>
