...
export default function PrivacyPage() {
  return <PageShell>
    ...
    <section className="section container legal-copy">
      <h2>目前的表单状态</h2>
      <p>当前网站表单不会连接数据库或客户管理系统。提交后，网站会调用访问者设备上的邮件应用，并将表单内容预先填写为发送至 shengtujy@163.com 的邮件；只有访问者在邮件应用中确认发送后，公司才会收到信息。网站本身不会保存表单内容。</p>
      <h2>计划收集的信息</h2>
      ...
      <p className="legal-review-note">如后续将表单连接后台、邮件服务或客户管理系统，应同步补充保存期限、技术服务商、Cookie 使用和跨境处理的具体信息。</p>
    </section>
  </PageShell>;
}
